    ...
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('lock_period', 1.0),
                ('publish_frequency', 10.0)  # 新增参数：控制话题发布频率
            ]
        )
        ...
        self.publish_frequency = self.get_parameter('publish_frequency').value  # 获取发布频率参数
        ...
        # 根据发布频率创建定时器
        self.timer = self.create_timer(1.0 / self.publish_frequency, self.publish_messages)
